OPEN-TAG-WEB
====
[open-tag](https://github.com/X-lab2017/open-tag) 前端项目
Overview
----
...
- 拉取项目代码
```bash
git clone https://github.com/xlab2017/open-tag-web.git
cd  open-tag-web
```
...
# 2.修改前端项目的后台域名
    .env.development
    域名改成： http://localhost:8080/jeecg-boot
   
# 3.进入项目根目录，执行打包命令
  yarn run build

# 4.构建镜像
  docker build -t open-tag-web .

# 5.启动镜像
  docker run --name open-tag-web -p 80:80 -d open-tag-web
